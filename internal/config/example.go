...
#
# Generated by firedozed -init-config. Edit any remaining placeholder values
# before starting firedozed. Placeholder values are marked with:
# EDIT PLACEHOLDER
...
`, t.BaseDomain, t.WGAddress, t.Endpoint, t.VMSubnet)
}
